...
/* harmony import */ var _sin_in_sin_in_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./sin-in/sin-in.component */ "./src/app/sin-in/sin-in.component.ts");
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot([
                    {
                        path: 'login',
                        component: _sin_in_sin_in_component__WEBPACK_IMPORTED_MODULE_9__["SinInComponent"],
                    }
                ]),
                _app_routing__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"],
                ngx_toggle_switch__WEBPACK_IMPORTED_MODULE_10__["UiSwitchModule"],
                ngx_webstorage__WEBPACK_IMPORTED_MODULE_11__["NgxWebstorageModule"].forRoot()
            ],
            declarations: [
                _app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"],
                _layouts_admin_layout_admin_layout_component__WEBPACK_IMPORTED_MODULE_8__["AdminLayoutComponent"],
                _sin_in_sin_in_component__WEBPACK_IMPORTED_MODULE_9__["SinInComponent"],
            ],
            providers: [],
...
module.exports = "nav{\r\n    background-color:rgb(0, 27, 35) !important;  /* fallback for old browsers */  /* Chrome 10-25, Safari 5.1-6 */\r\nbackground-image: linear-gradient(#1D2671); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */\r\n    color: white;\r\n}\r\n.navbar.navbar-transparent{\r\n    background-color: rgb(0, 27, 35) !important;\r\n}"
...
/***/ "./src/app/sin-in/sin-in.component.html":
/*!**********************************************!*\
  !*** ./src/app/sin-in/sin-in.component.html ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "./src/app/sin-in/sin-in.component.ts":
/*!********************************************!*\
  !*** ./src/app/sin-in/sin-in.component.ts ***!
  \********************************************/
/*! exports provided: SinInComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SinInComponent", function() { return SinInComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _sin_in_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sin-in.service */ "./src/app/sin-in/sin-in.service.ts");
...
var SinInComponent = /** @class */ (function () {
    function SinInComponent(router, signin, storage) {
        this.router = router;
        this.signin = signin;
    ...
    SinInComponent.prototype.ngOnInit = function () {
    };
    SinInComponent.prototype.btnClick = function (param1, param2) {
        var _this = this;
        if (param1 != "" && param2 != "") {
            var body = {
            ...
            this.signin.btnClick(body).subscribe(function (Response) {
                if (Response.ReturnCode == "RIS") {
                    console.log(Response);
                    _this.storage.store("employee_email", param1);
                    _this.storage.store("emp_password", param2);
    ...
    SinInComponent.prototype.select = function () {
        this.book1 = false;
        this.book2 = true;
    };
    SinInComponent.prototype.select1 = function (empname, email, mobno, empid, roolid, statusid, psw) {
        var body = {
        ...
        this.signin.select1(body).subscribe(function (Response) {
            if (Response.ReturnCode == "RIS") {
    ...
    SinInComponent.prototype.department = function () {
        var _this = this;
        this.signin.department().subscribe(function (Response) {
            if (Response.ReturnCode == "RRS") {
                _this.dept = Response.Returnvalue;
            }
        });
    };
    SinInComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-sin-in',
            template: __webpack_require__(/*! ./sin-in.component.html */ "./src/app/sin-in/sin-in.component.html"),
            styles: [__webpack_require__(/*! ./sin-in.component.scss */ "./src/app/sin-in/sin-in.component.scss")],
            providers: [_sin_in_service__WEBPACK_IMPORTED_MODULE_2__["SinInService"]],
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _sin_in_service__WEBPACK_IMPORTED_MODULE_2__["SinInService"], ngx_webstorage__WEBPACK_IMPORTED_MODULE_3__["LocalStorageService"]])
    ], SinInComponent);
    return SinInComponent;
}());
...
/***/ "./src/app/sin-in/sin-in.service.ts":
/*!******************************************!*\
  !*** ./src/app/sin-in/sin-in.service.ts ***!
  \******************************************/
/*! exports provided: SinInService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SinInService", function() { return SinInService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
module.exports = __webpack_require__(/*! C:\Users\infocuit\New folder\Multioderingsystem\Multioderingsystem\Multioderingsystem\src\main.ts */"./src/main.ts");
